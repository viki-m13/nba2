#!/usr/bin/env python3
"""
MLB Experiment — Run backtest, optimization, and validation.

Usage:
    python experiments/mlb/run_backtest.py                    # backtest only
    python experiments/mlb/run_backtest.py --optimize 50      # optimize for 50 iterations
    python experiments/mlb/run_backtest.py --validate         # full validation suite
    python experiments/mlb/run_backtest.py --objective roi    # roi/accuracy/balanced
"""
...
def main():
    parser = argparse.ArgumentParser(description='MLB ROI Experiment')
